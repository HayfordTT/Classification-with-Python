...
# #Using different clusters: 5 , 6, 7, 8 to check which cluster has the best acuracy.
...
neighK7 = KNeighborsClassifier(n_neighbors = k).fit(X_train,y_train)
neighK7
...
from sklearn import metrics
print("Train set Accuracy: ", metrics.accuracy_score(y_train, neighK7.predict(X_train)))
print("Test set Accuracy: ", metrics.accuracy_score(y_test, yhat))
...
neighK8 = KNeighborsClassifier(n_neighbors = k).fit(X_train,y_train)
neighK8
...
from sklearn import metrics
print("Train set Accuracy: ", metrics.accuracy_score(y_train, neighK8.predict(X_train)))
print("Test set Accuracy: ", metrics.accuracy_score(y_test, yhat))
